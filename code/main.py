...
def send_message_to_chat_gpt(token):
    ...
    utils = Utils(ratings)
    chat_gpt = Open_AI('gpt-3.5-turbo', token)
...
def main():
    ...
    token = ''
    checkpoint_dir = '../data/dataset/facebook_book/v2/gpt-3.5-turbo-1106/checkpoints_rerank_userknn'
    try:
    ...
    convert_chat_gpt_facebook_book(checkpoint_dir=checkpoint_dir,
                                    output_path=checkpoint_dir+'output_exp_3_rec_book_rerank_userknn.tsv')
